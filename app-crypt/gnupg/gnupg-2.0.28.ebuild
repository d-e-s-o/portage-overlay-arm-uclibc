...
src_configure() {
	...
	myconf+=( gnupg_cv_pth_is_sane=yes )
	...
	sed -i 's!-I/usr/include!-I/usr/armv6j-hardfloat-linux-uclibceabi/usr/include!g' \
	  common/Makefile \
	  agent/Makefile
	sed -i 's!-L/usr/lib64!-L/usr/armv6j-hardfloat-linux-uclibceabi/usr/lib!g' \
	  kbx/Makefile \
	  g10/Makefile \
	  sm/Makefile \
	  agent/Makefile \

...
src_configure() {
	...
	vim_cv_toupper_broken=0 \
	vim_cv_terminfo=1 \
	vim_cv_tty_group=1 \
	vim_cv_tty_mode=1 \
	vim_cv_getcwd_broken=0 \
	vim_cv_stat_ignores_slash=0 \
	vim_cv_memmove_handles_overlap=1 \
	vim_cv_bcopy_handles_overlap=0 \
	vim_cv_memcpy_handles_overlap=0 \
	econf \
